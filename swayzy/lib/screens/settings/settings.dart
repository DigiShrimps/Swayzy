            ...
            SettingsSection(
              ...
              tiles: <SettingsTile>[
                SettingsTile.navigation(
                  ...
                  onPressed: (context) {
                    Navigator.of(context).pushNamed('/socialDialog', arguments: 'Instagram');
                  },
                ),
                SettingsTile.navigation(
                  ...
                  onPressed: (context) {
                    Navigator.of(context).pushNamed('/socialDialog', arguments: 'Telegram');
                  },
                ),
                SettingsTile.navigation(
                  ...
                  onPressed: (context) {
                    Navigator.of(context).pushNamed('/socialDialog', arguments: 'TikTok');
                  },
                ),
                SettingsTile.navigation(
                  ...
                  onPressed: (context) {
                    Navigator.of(context).pushNamed('/socialDialog', arguments: 'Facebook');
                  },
                ),
                SettingsTile.navigation(
                  ...
                  onPressed: (context) {
                    Navigator.of(context).pushNamed('/socialDialog', arguments: 'Reddit');
                  },
                ),
              ],
            ),
