...
final List<Category> appCategories = [
  Category(title: "Electronics", pathToImage: AppImagesPaths.categoryMockElectronics,),
  Category(title: "Services", pathToImage: AppImagesPaths.categoryMockServices,),
  Category(title: "Vehicles", pathToImage: AppImagesPaths.categoryMockAutomobiles,),
